    ...
    <div className="space-y-6 max-w-7xl mx-auto p-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white mt-1">User Administration</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage, suspend, and view user profiles.</p>
        </div>
