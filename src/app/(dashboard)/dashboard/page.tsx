...
import { useTheme } from '@/providers/ThemeProvider'; // ← adjust path if your ThemeProvider lives elsewhere
      ...
      <div className={styles.overviewHeader}>
        ...
        <div className={styles.overviewActions}>
          ...
          <button className={styles.actionBtn}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 3v14m0 0l-5-5m5 5l5-5M5 21h14"/></svg>
            Request
          </button>
          <button className={styles.actionBtn}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 9h18M8 4v3M16 4v3"/></svg>
            Bills
          </button>
      ...
      <div className={styles.mainGrid}>
        ...
        <div className={styles.rightCol}>
          ...
          <div className={styles.scoreCard}>
            ...
            <Link href="/score" className={styles.scoreLinkBtn}>
              See breakdown
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </Link>
          </div>
          ...
          <div className={styles.walletsCard}>
            ...
            <div className={styles.walletsList}>
              <div className={`${styles.walletItem} ${styles.walletHighlight}`}>
